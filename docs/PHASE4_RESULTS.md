...
model. Same honesty standard as
[`PHASE0_FEATURES_AND_IMPROVEMENTS.md`](PHASE0_FEATURES_AND_IMPROVEMENTS.md)
and [`P1_FEATURES_AND_RESULTS.md`](P1_FEATURES_AND_RESULTS.md): both the
win and a genuine LLM-proposed failure are reported exactly as they
